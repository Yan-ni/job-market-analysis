...
DE_MAIN_SCRIPT_FILE="$DIR_PATH/data_collection.sh --container de-script"
...
echo "0 5 * * * $DE_MAIN_SCRIPT_FILE" >> "$TEMP_CRON" # Every day at 05:00

echo "0 7 * * * $UPDATE_DELETED_SCRIPT_FILE" >> "$TEMP_CRON" # Every day at 07:00
